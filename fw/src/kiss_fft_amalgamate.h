...
#ifdef KISS_FFT_AMALG_IMPL

#define KISS_FFT_MALLOC my_kiss_fft_malloc

static uint8_t my_kiss_fft_buf[MY_KISS_FFT_BUF_SIZE];
static uint32_t my_kiss_fft_buf_ptr = 0;

void *my_kiss_fft_malloc(size_t n_bytes)
{
...
#ifndef NDEBUG
#define NDEBUG  // Suppress KISS FFT logs
#endif

#endif  // #ifdef KISS_FFT_AMALG_IMPL
